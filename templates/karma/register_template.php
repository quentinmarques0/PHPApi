...
//CONTACT
Modules::register('contact-css',                    "modules/contact/css.php");
Modules::register('contact-meta',                   "modules/contact/meta.php");
Modules::register('contact-scripts',                "modules/contact/scripts.php");
Modules::register('contact-banner',                 "modules/contact/banner.php");
Modules::register('contact-area',                   "modules/contact/area.php");
Modules::register('contact-area-form',              "modules/contact/area/form.php");
Modules::register('contact-area-informations',      "modules/contact/area/informations.php");
Modules::register('contact-area-result',            "modules/contact/area/result.php");

//HOME
Modules::register('home-css',                       "modules/home/css.php");
Modules::register('home-meta',                      "modules/home/meta.php");
Modules::register('scripts',                        "modules/scripts.php");
...
Modules::register('related-products',               "modules/related/products.php");
Modules::register('related-products-titlesubtitle', "modules/related/products/title_subtitle.php");
Modules::register('related-products-products',      "modules/related/products/products.php");
Modules::register('related-products-bigimage',      "modules/related/products/big_image.php");
